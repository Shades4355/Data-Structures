...
public class Test {
    // Test DLL from partner and Deque.java
    public static void main(String[] args) {
        
        System.out.println("\nString List:");
        Deque<String> strList = new Deque<String>(); // create an empty list
        System.out.println("Is Empty: " + strList.isEmpty()); // true
        strList.addFirst("First node");
        strList.add("Middle node"); // add() == addLast()
        strList.addLast("Last node");
        ...
        System.out.println("First Element (Removed): " + strList.removeFirst()); // "First node"
